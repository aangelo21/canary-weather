    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 auto-rows-[minmax(180px,auto)] mb-32">
        ...
        <div className="col-span-1 md:col-span-2 row-span-2 bg-slate-900/40 backdrop-blur-md border border-white/5 rounded-4xl p-10 flex flex-col justify-between group hover:bg-slate-900/60 transition-all duration-500 hover:border-cyan-500/30 relative overflow-hidden">
            ...
            <div className="relative z-10">
                ...
                <h2 className="text-3xl font-bold text-white mb-4">
                    {t('ourPhilosophy') || 'Our Philosophy'}
                </h2>
        ...
        <div className="col-span-1 bg-linear-to-b from-slate-800/50 to-slate-900/50 backdrop-blur-md border border-white/5 rounded-4xl p-8 flex flex-col justify-center items-center text-center group hover:-translate-y-1 transition-transform duration-300">
            <div className="relative mb-4">
                ...
                <svg
                    className="w-12 h-12 text-amber-400 relative z-10"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                >
            ...
            <span className="text-xs font-mono text-slate-500 uppercase mt-1">
        ...
        <div className="col-span-1 row-span-2 bg-slate-900/40 backdrop-blur-md border border-white/5 rounded-4xl p-8 flex flex-col items-center text-center hover:border-blue-500/30 transition-colors duration-300 group">
            ...
            <p className="text-blue-400 text-sm font-medium tracking-wide mb-6">
                BACKEND DEVELOPER
            </p>
        ...
        <div className="col-span-1 row-span-2 bg-slate-900/40 backdrop-blur-md border border-white/5 rounded-4xl p-8 flex flex-col items-center text-center hover:border-teal-500/30 transition-colors duration-300 group">
            ...
            <p className="text-teal-400 text-sm font-medium tracking-wide mb-6">
                FRONTEND DEVELOPER
            </p>
            <p className="text-slate-400 text-sm leading-relaxed mb-8">
                {t('gabrielBio') ||
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                ...
                <div className="md:w-2/3 grid grid-cols-2 sm:grid-cols-4 gap-8">
                    {[
                        ...
                        <div
                            key={tech.name}
                            className="flex flex-col items-center justify-center p-6 bg-white/5 rounded-xl hover:bg-white/10 transition-colors"
                        >
            ...
            {[
                {
                    ...
                    desc: t('roadmap.q4_2025.desc'),
                    active: true,
                },
                {
                    year: 'Q1 2027',
                    title: t('roadmap.q1_2026.title'),
                    desc: t('roadmap.q1_2026.desc'),
                    active: false,
                },
                {
                    year: 'Q2 2027',
                    title: t('roadmap.q2_2026.title'),
                    desc: t('roadmap.q2_2026.desc'),
                    active: false,
                },
            ].map((item, index) => (
                <div
                ...
                >
                    <div className="flex items-center justify-center w-10 h-10 rounded-full border border-slate-700 bg-slate-900 shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 group-hover:border-cyan-500 transition-colors">
                        <div
                            className={`w-3 h-3 rounded-full ${item.active ? 'bg-cyan-500 animate-pulse' : 'bg-slate-600'}`}
                        ></div>
                    </div>
                    ...
                    <div className="lg:col-span-2 relative p-12 flex flex-col justify-between overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-slate-300 text-lg leading-relaxed mb-12">
                                {t('contactDesc') ||
                                    'Building the future of weather forecasting requires community. Whether you have a feature request, a bug report, or just want to talk meteorology, we are all ears.'}
                            </p>
                        </div>
                            ...
                            >
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                    ...
                                    <div className="relative">
                                        ...
                                        <label
                                            htmlFor="subject"
                                            className={labelClasses('subject')}
                                        >
                                ...
                                <div className="relative">
                                    ...
                                    <label
                                        htmlFor="message"
                                        className={labelClasses('message')}
                                    >
