          ...
          <div className="flex flex-col justify-center h-full">
            <div>
              ...
              <p className="mt-6 text-lg md:text-xl text-neutral-2 max-w-xl">
                Descubre el clima en tus lugares favoritos. Explora los mapas y
                ve pronósticos detallados, mareas y puntos de interés alrededor
          ...
          {[
            {
              ...
              icon: (
                ...
                >
                  <path
                    d="M12 3v2M12 19v2M4.22 4.22l1.42 1.42M18.36 18.36l1.42 1.42"
                    stroke="#0f6fa8"
                    strokeWidth="1.4"
                    strokeLinecap="round"
