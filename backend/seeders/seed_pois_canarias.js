    ...
    const pois = [
        {
            ...
            longitude: -16.6425,
            description:
                "Parque nacional alrededor del volcán Teide. Paisajes volcánicos y miradores.",
        ...
        },
        {
            ...
            longitude: -16.8448,
            description:
                "Imponentes acantilados en la costa oeste de Tenerife.",
            locationName: "Tenerife",
        },
        {
        ...
        },
        {
            ...
            longitude: -13.8499,
            description:
                "Conjunto de playas muy apreciadas por su claridad y arena.",
            locationName: "Lanzarote",
        },
...

        {
            ...
            longitude: -17.8398,
            description:
                "Parque nacional con impresionantes barrancos y bosques.",
...

        {
            ...
            longitude: -17.9636,
            description:
                "Mirador diseñado por César Manrique con vistas al mar.",
